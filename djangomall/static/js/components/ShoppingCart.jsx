...
export const ShoppingCart = function () {
  ...
  return (
    <div className="row">
                ...
                return (
                  <tr key={cartLine.id}>
                    <td>
                      <figure className="media">
                        <div className="img-wrap mr-3">
                          <img
                            src={cartLine.product_variant_details.images}
                    ...
                    <td className="text-right">
                      <a href="" onClick={(e) => deleteCartLine(e, cartLine.id)} className="btn btn-outline-danger">
                        {' '}
                        ×{' '}
                      </a>
                    </td>
      ...
      <ShoppingCartForm priceTotal={ cartLines.map(l => parseFloat(l.total)).reduce((a,b) => a + b, 0) } />
    </div>
  );
};
